    ...
    return (
        <div className="col-md-4 mb-4">
          <div className="card card-body">
            ...
            <button onClick={()=>history.push(`/updateCompany/${company.id}`)} className="ms-2 btn btn-sm btn-info">Update</button></h3>
            ...
            <button onClick={()=>company.id && handleDelete(company.id)} className="btn btn-danger my-2">Delete Companny</button>
          </div>
        </div>
    );
};
